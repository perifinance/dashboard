...
const Header = () => {
    ...
    return <div className="relative lg:flex w-full lg:max-w-screen-xl lg:mx-auto lg:px-0 lg:gap-12">
                <div className="flex flex-none px-4 lg:px-0 lg:w-24 lg:h-16">
                    <Link className="logo" to="/"><img className="w-8 h-8 lg:w-24 lg:h-16" alt="Logo"/></Link>
