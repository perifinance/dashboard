        ...
        <Card>
                    ...
                    <div className="flex flex-col w-fit lg:pl-5 items-start">
                        ...
                        <div className="flex flex-row gap-5 items-end">
                            <div className="flex flex-row items-end flex-nowrap text-xl font-medium text-blue-500">
                                ...
                                <span
                                    className={`text-[10px] ml-1 h-7 text-nowrap ${
                                        change ? (change < 0 ? " text-red-600" : " text-blue-500") : "hidden"
                                    }`}
                                >
            ...
            <div className="w-full h-[100px] text-2xs lg:max-w-100">
                <ResponsiveContainer width="100%" height="100%" debounce={1} maxHeight={100}>
                    <AreaChart data={rates} margin={{ top: 5, right: 0, left: 0, bottom: 15 }}>
                        <defs>
                            <linearGradient id="colorUv" x1="0" y1="0" x2="0" y2="1">
                                <stop offset="5%" stopColor="#0e23e3" stopOpacity={0.8} />
                                <stop offset="95%" stopColor="#0e23e3" stopOpacity={0} />
                            </linearGradient>
                        </defs>
